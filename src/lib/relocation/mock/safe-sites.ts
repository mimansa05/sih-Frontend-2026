...
export const MOCK_SAFE_SITES: SafeSite[] = [
  ...
  { id: "site-uk-03", name: "Guptkashi Transit Shelter", kind: "Transit camp", state: "Uttarakhand", district: "Rudraprayag", lng: 79.05, lat: 30.53, totalCapacity: 800, occupiedCapacity: 120, safetyScore: 89, helpline: "1800-000-1004", status: "safe" },
  ...
  { id: "site-uk-06", name: "Barkot Transit Shelter", kind: "Transit camp", state: "Uttarakhand", district: "Uttarkashi", lng: 78.3, lat: 30.6, totalCapacity: 700, occupiedCapacity: 90, safetyScore: 87, helpline: "1800-000-1007", status: "safe" },
  ...
  { id: "site-sk-02", name: "Singtam Transit Shelter", kind: "Transit camp", state: "Sikkim", district: "Gangtok", lng: 88.48, lat: 27.23, totalCapacity: 700, occupiedCapacity: 80, safetyScore: 88, helpline: "1800-000-1019", status: "safe" },
  ...
  // ── Assam / Arunachal ───────────────────────────────────────────────────
  { id: "site-as-01", name: "Tinsukia Flood Relief Camp", kind: "Relief centre", state: "Assam", district: "Tinsukia", lng: 95.36, lat: 27.49, totalCapacity: 1800, occupiedCapacity: 300, safetyScore: 92, helpline: "1800-000-1022", status: "safe" },
  { id: "site-as-02", name: "Naharkatia Shelter Complex", kind: "Shelter complex", state: "Assam", district: "Dibrugarh", lng: 95.33, lat: 27.29, totalCapacity: 1200, occupiedCapacity: 150, safetyScore: 90, helpline: "1800-000-1023", status: "safe" },
  ...
  { id: "site-br-03", name: "Madhubani Transit Camp", kind: "Transit camp", state: "Bihar", district: "Madhubani", lng: 86.07, lat: 26.35, totalCapacity: 1500, occupiedCapacity: 250, safetyScore: 88, helpline: "1800-000-1031", status: "safe" },
  { id: "site-br-04", name: "Saharsa Relief Centre", kind: "Relief centre", state: "Bihar", district: "Saharsa", lng: 86.59, lat: 25.88, totalCapacity: 1600, occupiedCapacity: 200, safetyScore: 89, helpline: "1800-000-1032", status: "safe" },
  ...
  // ── Odisha ──────────────────────────────────────────────────────────────
  { id: "site-od-01", name: "Rajnagar Coastal Shelter", kind: "Cyclone shelter", state: "Odisha", district: "Kendrapara", lng: 86.72, lat: 20.6, totalCapacity: 900, occupiedCapacity: 0, safetyScore: 90, helpline: "1800-000-1038", status: "safe" },
  { id: "site-od-02", name: "Kendrapara District Shelter", kind: "Shelter complex", state: "Odisha", district: "Kendrapara", lng: 86.5, lat: 20.62, totalCapacity: 1200, occupiedCapacity: 600, safetyScore: 88, helpline: "1800-000-1039", status: "safe" },
