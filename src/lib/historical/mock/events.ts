...
export const HISTORICAL_EVENTS: HistoricalEvent[] = [
  ...
  // ── 2026 — current-year activity (season in progress; figures provisional) ──
  { id: "h-2026-ls-uk-chm", year: 2026, hazard: "landslide", name: "Joshimath crown-crack reactivation", state: "Uttarakhand", district: "Chamoli", deaths: 4, displaced: 2600, damageCr: 190 },
  { id: "h-2026-ls-uk-rud", year: 2026, hazard: "landslide", name: "Rudraprayag NH-107 slide cluster", state: "Uttarakhand", district: "Rudraprayag", deaths: 11, displaced: 1900, damageCr: 130 },
  { id: "h-2026-ls-mh-rgd", year: 2026, hazard: "landslide", name: "Irshalwadi ridge slippage", state: "Maharashtra", district: "Raigad", deaths: 9, displaced: 1200, damageCr: 85 },
  { id: "h-2026-ls-wb-dar", year: 2026, hazard: "landslide", name: "Darjeeling tea-belt slumps", state: "West Bengal", district: "Darjeeling", deaths: 6, displaced: 3400, damageCr: 120 },
  { id: "h-2026-fl-as-dbr", year: 2026, hazard: "flood", name: "Dibrugarh Brahmaputra breach", state: "Assam", district: "Dibrugarh", deaths: 27, displaced: 210000, damageCr: 940 },
  { id: "h-2026-fl-br-drb", year: 2026, hazard: "flood", name: "Darbhanga Kosi spill", state: "Bihar", district: "Darbhanga", deaths: 19, displaced: 168000, damageCr: 610 },
  { id: "h-2026-fl-up-gor", year: 2026, hazard: "flood", name: "Gorakhpur Rapti inundation", state: "Uttar Pradesh", district: "Gorakhpur", deaths: 14, displaced: 96000, damageCr: 380 },
  { id: "h-2026-fl-kl-alp", year: 2026, hazard: "flood", name: "Kuttanad backwater flooding", state: "Kerala", district: "Alappuzha", deaths: 5, displaced: 42000, damageCr: 220 },
  { id: "h-2026-cb-uk-ked", year: 2026, hazard: "cloudburst", name: "Kedarnath trail cloudburst", state: "Uttarakhand", district: "Rudraprayag", deaths: 33, displaced: 8600, damageCr: 470 },
  { id: "h-2026-cb-uk-chm", year: 2026, hazard: "cloudburst", name: "Chamoli Alaknanda cloudburst", state: "Uttarakhand", district: "Chamoli", deaths: 12, displaced: 3100, damageCr: 180 },
  { id: "h-2026-cb-hp-kul", year: 2026, hazard: "cloudburst", name: "Kullu Sainj valley cloudburst", state: "Himachal Pradesh", district: "Kullu", deaths: 21, displaced: 5400, damageCr: 300 },
  { id: "h-2026-cb-jk-kis", year: 2026, hazard: "cloudburst", name: "Kishtwar Marwah cloudburst", state: "Jammu & Kashmir", district: "Kishtwar", deaths: 8, displaced: 1500, damageCr: 95 },
  { id: "h-2026-ce-od-ken", year: 2026, hazard: "coastal_erosion", name: "Satabhaya further land loss", state: "Odisha", district: "Kendrapara", deaths: 0, displaced: 2100, damageCr: 70 },
  { id: "h-2026-ce-wb-s24", year: 2026, hazard: "coastal_erosion", name: "Ghoramara monsoon erosion", state: "West Bengal", district: "South 24 Parganas", deaths: 0, displaced: 1800, damageCr: 60 },
  { id: "h-2026-ce-ap-kri", year: 2026, hazard: "coastal_erosion", name: "Machilipatnam coast breach", state: "Andhra Pradesh", district: "Krishna", deaths: 1, displaced: 2400, damageCr: 110 },
  { id: "h-2026-ce-gj-dwk", year: 2026, hazard: "coastal_erosion", name: "Okha-Dwarka shoreline loss", state: "Gujarat", district: "Devbhumi Dwarka", deaths: 0, displaced: 1600, damageCr: 75 },
];
