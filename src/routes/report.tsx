    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="report-sheet mx-auto max-w-3xl space-y-5 p-6 md:p-10">
        ...
        <p className="report-block border-t border-border pt-3 text-[10px] leading-relaxed text-muted-foreground">
          Generated by DISCATRA GIS Risk Command from a validated relocation plan. Facility records,
          capacities and helpline numbers in this build are demonstration data and are not an
          official register.
        </p>
      </main>
    </div>
